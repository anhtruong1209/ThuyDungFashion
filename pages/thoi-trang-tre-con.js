...
export default function ThoiTrangTreCon() {
  ...
  const currentProducts = kidsProducts.slice(indexOfFirstProduct, indexOfLastProduct);
  ...
  return (
    <div className="min-h-screen">
      <Head>
        <title>Thời Trang Trẻ Con | ThuyDung Fashion</title>
        <meta name="description" content="Khám phá bộ sưu tập thời trang cao cấp dành cho trẻ em từ ThuyDung." />
      ...
      <main className="pt-24 pb-16">
        <div className="container-custom">
          <h1 className="section-title mb-12">BỘ SƯU TẬP THỜI TRANG TRẺ EM</h1>
          
          <div className="text-center mb-12">
            <p className="max-w-2xl mx-auto text-lg text-gray-600 mb-8">
              Khám phá bộ sưu tập thời trang cao cấp mới nhất dành cho trẻ em từ ThuyDung. 
              Những thiết kế đáng yêu, năng động và thoải mái cho các bé.
            </p>
          </div>
            ...
            {currentProducts.map((product) => (
              <div key={product.id} className="product-card group">
                <div className="overflow-hidden">
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-0 right-0 text-center opacity-0 transform translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                      <Link href={`/thoi-trang-tre-con/${product.id}`} className="bg-white text-black py-2 px-4 rounded-sm shadow-md hover:bg-gray-100 transition-colors font-medium inline-block">
                        Xem chi tiết
                      </Link>
                    </div>
                  </div>
                ...
                <div className="product-card-content mt-4">
                  <Link href={`/thoi-trang-tre-con/${product.id}`} className="block">
