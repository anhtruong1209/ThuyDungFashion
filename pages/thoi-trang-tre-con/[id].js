...
export default function ProductDetail() {
  ...
  useEffect(() => {
    if (id) {
      ...
      const foundProduct = kidsProducts.find(p => p.id === parseInt(id));
      
      if (foundProduct) {
        setProduct(foundProduct);
      } else {
        // Nếu không tìm thấy sản phẩm
        router.push('/thoi-trang-tre-con');
      }
      ...
      <main className="pt-24 pb-16">
        <div className="container-custom">
          ...
          <div className="flex items-center mb-8 text-sm">
            ...
            <Link href="/thoi-trang-tre-con" className="text-gray-500 hover:text-black">
              Thời trang trẻ con
            </Link>
            <span className="mx-2">/</span>
          ...
          {/* Nút quay lại */}
          <Link href="/thoi-trang-tre-con" className="inline-flex items-center mb-8 text-gray-700 hover:text-black transition-colors">
